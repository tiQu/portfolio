...
class Education extends React.Component{
    render(){
        return (
            <section className="hobbies-parent">
                <div className="hobbies hobby1">
                    <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-keyboard" viewBox="0 0 16 16">
                ...
                <div className="hobbies hobby2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-droplet-fill" viewBox="0 0 16 16">
                ...
                <div className="hobbies hobby4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-headphones" viewBox="0 0 16 16">

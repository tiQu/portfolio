export const EduItems = [
    ...
    },
    {
        ...
        eduSummary: "The Master of Publishing, dubbed 'the MBA for the creative industries', is an intensive graduate program that combines various publishing-related fields, like editing, management, and layout / design. While on a Mitacs-funded research placement at Vision Critical, I conducted a series of exploratory analyses of a combination of data from social media and surveys. This was to demonstrate how such data can benefit publishers in the magazine and newspaper industries."
    },
    {
        eduHeader: "Bachelor of Arts - Applied Media Science",
